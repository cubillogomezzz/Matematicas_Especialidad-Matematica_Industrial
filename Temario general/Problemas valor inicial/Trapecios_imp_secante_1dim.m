%% Método trapecio unidimensional:
% Cuadratura trapecio, método implícito. Resolucíón numérica de ecuaciones
% implícitas mediante secante (punto fijo para primera)
